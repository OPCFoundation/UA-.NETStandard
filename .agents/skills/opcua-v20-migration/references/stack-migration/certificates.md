...
See [CertificateManager.md](https://github.com/OPCFoundation/UA-.NETStandard/blob/master/docs/CertificateManager.md) for the full API reference and usage guide.
...
without it. See
[CertificateManager.md § PushManagement Transactions](https://github.com/OPCFoundation/UA-.NETStandard/blob/master/docs/CertificateManager.md#pushmanagement-transactions-opc-ua-part-12-7102-71011)
...
[CertificateManager.md § Optional ServerConfiguration Surface](https://github.com/OPCFoundation/UA-.NETStandard/blob/master/docs/CertificateManager.md#optional-serverconfiguration-surface-opc-ua-part-12-7103-71013-71020).

...
| C32–C34 | Reference server coverage script defects (#4479) | — | Not filed |
...
### C32. Historical Access Read Raw `Err-025.js` expects `BadNotSupported`
...
### C33. Address Space Atomicity `001.js` only sees the first 10000 variables
...
### C34. View Basic 2 `015.js` compares browse results by position

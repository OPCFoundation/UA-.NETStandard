...
Write-Host "Assurance pilot: expected=$($assurance.expected) selected=$($assurance.selected) completed=$($assurance.completed) failed=$($assurance.failed) missing=$($assurance.missing) N/A=0."

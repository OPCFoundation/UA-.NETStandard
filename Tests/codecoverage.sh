...
rm -r ./CodeCoverage
rm -r ./TestResults
dotnet test "UA.slnx" -v n --configuration Release --framework net8.0 --collect:"XPlat Code Coverage"  --settings ./Tests/coverlet.runsettings.xml --results-directory ./TestResults

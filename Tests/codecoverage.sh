...
rm -r ./CodeCoverage
rm -r ./TestResults
dotnet test "UA Core Library.sln" -v n --configuration Release --framework net6.0 --collect:"XPlat Code Coverage"  --settings ./Tests/coverlet.runsettings.xml --results-directory ./TestResults

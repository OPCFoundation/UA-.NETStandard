...
namespace Opc.Ua.Gds.Tests
{
    ...
    public class CertificateGroupTests
    {
        ...
        public void TestCreateCACertificateAsyncThrowsException()
        {
            ...
            using var certificateGroup = (CertificateGroup)new CertificateGroup(telemetry).Create(
                m_path + "/authorities",
                configuration);
            Assert.That(
        ...
        public async Task Test_Ca_Signed_Cert_Can_Be_RevokedAsync()
        {
            ...
            using var otherCertGroup = (CertificateGroup)new CertificateGroup(telemetry).Create(
                m_path + "/authorities",
                configuration);

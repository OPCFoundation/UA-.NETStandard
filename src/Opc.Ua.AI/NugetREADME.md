# OPC UA AI Model Management and Inference (draft) model

Server- and client-independent contracts and the source-generated model for the draft *OPC UA - AI Model Management and Inference* companion specification: model catalogues, datasets, deployments, inference endpoints and learning jobs, over the abstract registry in *OPC UA - xRegistry*.

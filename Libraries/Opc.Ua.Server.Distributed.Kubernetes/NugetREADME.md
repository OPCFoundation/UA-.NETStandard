...
`OPCFoundation.NetStandard.Opc.Ua.Server.Distributed.Kubernetes` adds opt-in Kubernetes integration to `OPCFoundation.NetStandard.Opc.Ua.Server.Distributed`.

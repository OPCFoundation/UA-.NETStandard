...
carries a character outside the Basic Multilingual Plane. The comparer used here
therefore compares code points, and only falls back to the cheap path while both
strings stay inside the BMP.

...
```powershell
dotnet run --project samples\Vision\BinPickingClient\BinPickingClient.csproj --framework net10.0 -- --server opc.tcp://localhost:62855/BinPickingCell --insecure --view --mcp --transport http --port 5170
```
...
```powershell
dotnet run --project samples\Vision\BinPickingCell\BinPickingCell.csproj -- --insecure
dotnet run --project samples\Vision\BinPickingClient\BinPickingClient.csproj --framework net10.0 -- --server opc.tcp://localhost:62855/BinPickingCell --insecure --demo
```
...
```powershell
dotnet run --project samples\Vision\BinPickingClient\BinPickingClient.csproj --framework net10.0 -- --server opc.tcp://localhost:62855/BinPickingCell --insecure --view
```

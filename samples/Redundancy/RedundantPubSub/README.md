...
```powershell
dotnet run --project samples\Redundancy\RedundantPubSub\RedundantPubSub.csproj -- --role demo --ha-mode hot
```
...
```powershell
dotnet run --project samples\Redundancy\RedundantPubSub\RedundantPubSub.csproj -- --role demo --ha-mode cold
```
...
```powershell
dotnet run --project samples\Redundancy\RedundantPubSub\RedundantPubSub.csproj -- --role demo --ha-mode warm
```
...
```powershell
docker compose -f samples/Redundancy/RedundantPubSub/docker-compose.yml up --build
```
...
```powershell
docker compose -f samples/Redundancy/RedundantPubSub/docker-compose.yml stop publisher-a
```
...
```powershell
docker compose -f samples/Redundancy/RedundantPubSub/docker-compose.yml stop subscriber-a
```

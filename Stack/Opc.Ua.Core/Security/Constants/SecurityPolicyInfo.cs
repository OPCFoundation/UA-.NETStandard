...
namespace Opc.Ua
{
    ...
    public class SecurityPolicyInfo
    {
        ...
        /// </summary>
        public readonly static SecurityPolicyInfo None = new(SecurityPolicies.None)
        {
        ...
        /// </summary>
        public readonly static SecurityPolicyInfo Basic128Rsa15 = new(SecurityPolicies.Basic128Rsa15)
        {
        ...
        /// </summary>
        public readonly static SecurityPolicyInfo Aes128_Sha256_RsaOaep = new(SecurityPolicies.Aes128_Sha256_RsaOaep)
        {
        ...
        /// </summary>
        public readonly static SecurityPolicyInfo Basic256Sha256 = new(SecurityPolicies.Basic256Sha256)
        {
            DerivedSignatureKeyLength = 256/8,
        ...
        /// </summary>
        public readonly static SecurityPolicyInfo Aes256_Sha256_RsaPss = new(SecurityPolicies.Aes256_Sha256_RsaPss)
        {
            DerivedSignatureKeyLength = 256/8,
            SymmetricEncryptionKeyLength = 256/8,
            MinAsymmetricKeyLength = 2048,
        ...
        {
            DerivedSignatureKeyLength = 0,
            SymmetricEncryptionKeyLength = 384/8,
            InitializationVectorLength = 128/8,
            SymmetricSignatureLength = 128/8,
            MinAsymmetricKeyLength = 384,
            MaxAsymmetricKeyLength = 384,
        ...
        /// </summary>
        public readonly static SecurityPolicyInfo ECC_brainpoolP256_AES = new(SecurityPolicies.ECC_brainpoolP256r1_AES)
        {
            DerivedSignatureKeyLength = 0,
            SymmetricEncryptionKeyLength = 128/8,
            InitializationVectorLength = 96/8,

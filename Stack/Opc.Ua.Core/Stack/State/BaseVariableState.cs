...
namespace Opc.Ua
{
    ...
    public abstract class BaseVariableState : BaseInstanceState
    {
        ...
        /// <summary>
        /// The behaviour to use when reading or writing all or part of the object.
        /// </summary>
            ...
            ref DateTime sourceTimestamp)
        {
            ...
            // check if the read behaviour has been overridden.
            if (OnReadValue != null)
            {
                result = OnReadValue(
                    context,
            ...
            DateTime sourceTimestamp)
        {
            ...
            // check if the write behaviour has been overridden.

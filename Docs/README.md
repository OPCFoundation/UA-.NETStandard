...
* [Server DI and fluent hosting shortcuts](ServerDiFluentApi.md) - Server role-manager DI, fluent node-manager bridge, reverse-connect / operation-limit helpers, transport forwarders, and reference / secure server presets.

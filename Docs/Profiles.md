...
- **[HTTPS REST API](http://opcfoundation.org/UA-Profile/Transport/https-webapi)** (`opc.https://` and `https://`) - OPC UA OpenAPI Mapping (Part 6 §G.3)
  ...
  - Shipped in the optional `OPCFoundation.NetStandard.Opc.Ua.Bindings.WebApi` package (net8+ only)
